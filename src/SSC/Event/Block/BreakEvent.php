...
class BreakEvent implements Listener {
	 ...
	 */
	 public function onBreak(BlockBreakEvent $event) {
								 ...
								 if ($block->getSide(Vector3::SIDE_DOWN)->getId() === $block->getId()) {
									 ...
									 while (true) {
										 ...
										 if ($player->getLevel()->getBlock(new Vector3($x, $y + $n, $z))->getId() === $event->getBlock()->getId()) {
											 ...
											 if($playerdata->getVar("TRAPPIST")===250000or$playerdata->getVar("TRAPPIST")===50000) {
				...
				if($item->hasEnchantments()){
				 ...
				 switch ($id) {
					 ...
					 case 15:
						 ...
						 if($playerdata->getVar("DAIRY2")===8or$playerdata->getVar("DAIRY2")===9){
						 	$playerdata->addVar("DAIRYTASK2");
						 	if($playerdata->getMaxDairy2()===$playerdata->getNowDairy2()){
		 						$player->addTitle("§bデイリーボーナスを達成", "", 30, 30, 20);
						 	}
						 }
						 if($playerdata->getVar("IRON")===1000or$playerdata->getVar("IRON")===500) {
					 ...
					 case 14:
						 ...
						 if($playerdata->getVar("DAIRY1")===4or$playerdata->getVar("DAIRY1")===5){
						 ...
						 if($playerdata->getVar("GOLD")===100or$playerdata->getVar("GOLD")===500) {
					 ...
					 case 162:
						 $this->main->addEXP($player, 2);//木
					 	 ...
					 	 if($playerdata->getVar("WOOD")===1000or$playerdata->getVar("WOOD")===500) {
					 ...
					 case 21:
						 ...
						 if($playerdata->getVar("LAPIS")===50or$playerdata->getVar("LAPIS")===500) {
					 ...
					 case 56:
						 ...
						 if($playerdata->getVar("DAIRY2")===6or$playerdata->getVar("DAIRY2")===7or$playerdata->getVar("DAIRY2")===8or$playerdata->getVar("DAIRY2")===9){
						 	$playerdata->addVar("DAIRYTASK2");
						 	if($playerdata->getMaxDairy2()===$playerdata->getNowDairy2()){
		 						$player->addTitle("§bデイリーボーナスを達成", "", 30, 30, 20);
						 	}
						 }
						 if($playerdata->getVar("DIAMOND")===250or$playerdata->getVar("DIAMOND")===50) {
					 ...
					 case 74:
						 ...
						 if($playerdata->getVar("REDSTONE")===1000or$playerdata->getVar("REDSTONE")===7000) {
					 ...
					 case 129:
						 ...
						 if($playerdata->getVar("EMERALD")===10or$playerdata->getVar("EMERALD")===50) {
					 ...
					 case 16:
						 ...
						 if($playerdata->getVar("DAIRY1")===2or$playerdata->getVar("DAIRY1")===3){
						 	$playerdata->addVar("DAIRYTASK1");
						 	if($playerdata->getMaxDairy1()===$playerdata->getNowDairy1()){
		 						$player->addTitle("§bデイリーボーナスを達成", "", 30, 30, 20);
						 	}
						 ...
						 if($playerdata->getVar("COAL")===1000or$playerdata->getVar("COAL")===5000){
				 ...
				 if ($playerdata->getJob() == "木こり") {
					 ...
					 if ($event->getBlock()->getId() == 17 || $event->getBlock()->getId() == 162) {
						 ...
						 } else if ($event->getBlock()->getId() == 16) {
							 economyAPI::getInstance()->addMoney($name, 12);
						 } else if ($event->getBlock()->getId() == 129) {
							 economyAPI::getInstance()->addMoney($name, 15);
						 } else if ($event->getBlock()->getId() == 73 || $event->getBlock()->getId() == 74) {
							 economyAPI::getInstance()->addMoney($name, 20);
						 } else if ($event->getBlock()->getId() == 56) {
							 economyAPI::getInstance()->addMoney($name, 100);
						 } else if ($event->getBlock()->getId() == 21) {
		 ...
		 if($playerdata->getVar("BREAK")===1000000or$playerdata->getVar("BREAK")===100000){
